...
class Philosopher(threading.Thread):
 ...
 #Since the subclass overrides the constructor, it must make sure to invoke the base class constructor (Thread._init_()) before doing anything else to the thread.
